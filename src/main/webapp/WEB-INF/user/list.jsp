...
<div class="box-positon">
	...
	<form class="ropt">
		<input class="add" type="button" value="新增" onClick="javascript:window.location.href='toadd.do'"/>
	</form>
	<div class="clear"></div>
</div>
<div class="body-box">
...
<table cellspacing="1" cellpadding="0" border="0" width="100%" class="pn-ltable">
	...
	<c:forEach items="${LIST}" var="user" >
		<tr bgcolor="#ffffff" onMouseOut="this.bgColor='#ffffff'" onMouseOver="this.bgColor='#eeeeee'">
			...
			<td align="center">
			<a class="pn-opt" href="userget.do?id=${user.id} ">修改</a> | 
...
<div style="margin-top:15px;">
	...
	<a href="list.do?page=${PAGECONT}&loginname=${QUERY.loginname}&isenabled=${QUERY.isenabled}">最后页</a>&nbsp;&nbsp;&nbsp;&nbsp;当前第${PAGE}页 /共${PAGECONT}页
	</div>
</body>
</html>